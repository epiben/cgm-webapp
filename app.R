...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
        		radioGroupButtons("step", "Type", choices = list("30-min check", "First BGL", "On insulin", "Off insulin")),
            numericInputIcon("previous_bgl", "Previous blood glucose level", value=6.0, min=0, step=0.1, icon=list(NULL, "mmol/L")),
            numericInputIcon("current_bgl", "Current blood glucose level", value=6.0, min=0, step=0.1, icon=list(NULL, "mmol/L")),
            numericInputIcon("current_dose", "Insulin dose", value=0, min=0, step=1,  icon=list(NULL, "units/hour")),
        ),
